...
public class SettingsController {
    ...
    private final PasswordField passCField;
    private final JFXCheckBox gMuscle;
    private final JFXCheckBox gStrength;
    private final JFXCheckBox loseWeight;
    private final JFXCheckBox home;
    private final JFXCheckBox gym;
